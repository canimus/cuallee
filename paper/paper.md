...
On the other hand, `great-expectations` [@Gong_Great_Expectations] and `soda` [@soda_core] additionaly offer commercial options that require registration and issuing of keys for cloud reporting capabilities. 

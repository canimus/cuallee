...
def test_negative(check: Check, postgresql, db_conn_mysql):
...
def test_parameters(check: Check, postgresql, db_conn_mysql, rule_column):
...
def test_coverage(check: Check, postgresql, db_conn_mysql):

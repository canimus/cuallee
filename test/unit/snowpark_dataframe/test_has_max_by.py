...
def test_negative(snowpark):
    ...
    check = Check(CheckLevel.WARNING, "pytest")
    check.has_max_by("POPULATION", "CONTINENT", "Antartica")
    rs = check.validate(df)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [[[0.5, 7073651], [0.6, 73131839], [0.1, 62873]], ["PERCENTAGE", "POPULATION"], "PERCENTAGE", 0.6],
        [[[date(2012, 1, 11), 7073651], [date(2012, 2, 11), 73131839], [date(2012, 3, 11), 62873]], ["DATE", "POPULATION"], "DATE", date(2012, 2, 11)],
        [[[datetime(2012, 1, 11, 10, 10, 10), 7073651], [datetime(2012, 1, 11, 10, 11, 10), 73131839], [datetime(2012, 1, 11, 0, 10, 10), 62873]], ["TIMESTAMP", "POPULATION"], "TIMESTAMP", datetime(2012, 1, 11, 10, 11, 10)],
        ], 
...
def test_coverage():
    ...
    with pytest.raises(TypeError, match="positional arguments"):
        check.has_max_by("POPULATION", "CONTINENT", "Asia", 0.5)

...
@pytest.mark.parametrize(
    ...
    [
        [[["Europe", 7073651], ["Asia", 73131839], ["Antartica", 62873]], ["CONTINENT", "POPULATION"], "CONTINENT", "Antartica"],
        [[[2012, 7073651], [2013, 73131839], [2014, 62873]], ["YEAR", "POPULATION"], "YEAR", 2014],
        [[[0.5, 7073651], [0.6, 73131839], [0.1, 62873]], ["PERCENTAGE", "POPULATION"], "PERCENTAGE", 0.1],
        [[[date(2012, 1, 11), 7073651], [date(2012, 2, 11), 73131839], [date(2012, 3, 11), 62873]], ["DATE", "POPULATION"], "DATE", date(2012, 3, 11)],
        [[[datetime(2012, 1, 11, 10, 10, 10), 7073651], [datetime(2012, 1, 11, 10, 11, 10), 73131839], [datetime(2012, 1, 11, 0, 10, 10), 62873]], ["TIMESTAMP", "POPULATION"], "TIMESTAMP", datetime(2012, 1, 11, 0, 10, 10)],
        ], 
